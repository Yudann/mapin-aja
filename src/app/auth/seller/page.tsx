...
export default function AuthSellerPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        provider: "google",
        options: {
          redirectTo: `${window.location.origin}/api/auth/callback/seller`,
          queryParams: {
            access_type: "offline",
            prompt: "consent",
          },
  ...
  return (
    ...
    >
      ...
      >
        {/* LEFT SIDE - Seller Features */}
        <div
          className="lg:w-1/2 rounded-t-4xl lg:rounded-l-4xl lg:rounded-tr-none p-8 lg:p-12 relative overflow-hidden"
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div className="flex-1 flex flex-col justify-center space-y-6">
              ...
              >
                ...
                >
                  Platform lengkap untuk mengelola dan mengembangkan bisnis UMKM
                  Anda
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    desc: "Pantau performa bisnis real-time",
                  },
                  {
                    icon: BarChart3,
                    title: "Analisis Lengkap",
                    desc: "Insight untuk kembangkan bisnis",
                  },
                  {
                    icon: UsersIcon,
                    title: "Kelola Pelanggan",
                    desc: "Chat langsung dengan customer",
                  },
                ].map((feature, idx) => (
                  <motion.div
                    key={idx}
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Kelola bisnis UMKM Anda dengan tools yang lengkap dan mudah
                digunakan
              </p>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600 mb-4">
                Bukan pemilik UMKM? Daftar sebagai customer
              </p>
              <Link
                href="/auth/customer"
            ...
            <div className="mt-8 p-4 rounded-xl bg-gray-50">
              <p className="text-xs text-gray-600">
                <strong>Catatan:</strong> Sebagai seller, Anda akan melewati
                proses onboarding untuk mendaftarkan UMKM Anda sebelum dapat
                mengakses dashboard.
              </p>
            </div>
          </div>
