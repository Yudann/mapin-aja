...
const stats = [
  {
    ...
    value: "1,245",
    icon: Eye,
    color: "bg-linear-to-br from-brown-dark to-brown-accent",
  ...
  },
  {
    ...
    value: "4.8",
    icon: Star,
    color: "bg-linear-to-br from-brown-light to-brown-accent",
  ...
  },
  {
    ...
    value: "24",
    icon: Package,
    color: "bg-linear-to-bl from-brown-light to-brown-accent",
    textColor: "text-brown-dark",
  },
];
