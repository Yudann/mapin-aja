...
function UMKMCard({
  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100">
      ...
      <div className="p-4">
        ...
        <button className="w-full py-2.5 bg-linear-to-r from-brown-accent to-brown-dark  text-white rounded-xl font-bold text-sm hover:shadow-lg transition-all flex items-center justify-center gap-2 group-hover:scale-[1.02]">
