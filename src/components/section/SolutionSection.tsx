...
const SolutionSection = () => {
  ...
  return (
    <motion.section
      className="relative py-24 sm:py-32 bg-linear-to-b from-white via-brown-light]/30 to-white overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 -left-32 w-96 h-96 bg-brown-light/5 rounded-full blur-3xl" />
        <div className="absolute bottom-20 -right-32 w-[600px] h-[600px] bg-brown-light/10 rounded-full blur-3xl" />

        {/* Map Pin Pattern */}
        <div className="absolute top-40 right-20 opacity-5">
          <MapPin className="w-32 h-32 text-brown-light" />
        </div>
        <div className="absolute bottom-40 left-20 opacity-5">
          <MessageCircle className="w-28 h-28 text-brown-dark" />
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={cardVariant} className="text-center mb-20">
          <div className="inline-flex items-center justify-center space-x-2 mb-6 bg-linear-to-r from-brown-accent/10 to-brown-dark/10 border border-brown-accent/30 rounded-full px-6 py-3">
          ...
          <h2 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black text-gray-900 leading-none mb-8">
            ...
            <span className="relative inline-block mt-2">
              ...
              <motion.div
                className="absolute -bottom-3 left-0 right-0 h-4 bg-brown-light/20"
                initial={{ scaleX: 0 }}
